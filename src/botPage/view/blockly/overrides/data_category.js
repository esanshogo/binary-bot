...
Blockly.DataCategory = function(workspace) {
    ...
    if (variableModelList.length > 0) {
        // Don't nicely format XML generation, it'll break.
        ...
        operationsLabel.setAttribute('text', translate('Operations'));
        ...
        variablesLabel.setAttribute('text', translate('Variables'));
